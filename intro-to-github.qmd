...
![](figs/diff.png){fig-align="center" width=70%}

::: aside
Diffs allow us to quickly see what's changed in a file from the previous version. <span style="color: #87CEEB">Red</span> = deletion, <span style="color: #87CEEB">green</span> = addition.
:::
